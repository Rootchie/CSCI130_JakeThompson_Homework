...
void time2Fall(); // new variable shanghai tower height
...
int main() {
  ...
  // continue
  do {
    cout << "Determine the speed of a falling object after an elapsed time (t)."
         << endl;
  ...
  // note: shanghai tower height = 632.0 meters
  time2Fall(632.0);
