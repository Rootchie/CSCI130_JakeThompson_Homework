/******************************************************************************
Description: Rock, Paper, Scissors, Lizard, Spock Game [using arrays]
...
void GiveFeedback(char userPick, char computerPick);
//////////////////// MAIN ////////////////////////////////////////////////////
int main() {
  // declare vars
  ...
  // HANDOUT (PART C): Randomly display celebratory messages if user won, lost
  // or tied.
